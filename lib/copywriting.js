...
1. HOOK (1-2 sentences)
   Grab attention — unexpected angle, short statement, or relatable scenario.

2. VALUE / KEY SELLING POINTS (2-4 sentences, or ✌️ bullets)
   Highlight the relevant product features naturally. Incorporate 2-3 of the brand identity points above.

3. CALL-TO-ACTION
   Choose ONE from these real Fanz CTAs (pick the most appropriate for context):
...
4. WEBSITE (product/productivity posts only)
   🌐 https://fanz.my

5. HASHTAGS (5-8 tags, last line)
...
- Does it follow hook → value → CTA → URL → hashtags structure?
- Are emojis used sparingly and consistently?
